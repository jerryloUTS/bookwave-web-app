...
I was personally responsible for the login and register pages (for both regular users and administrators); catalogue page; and the addition, manipulation, and deletion of users, administrators and books. This reinforced my understanding of Object-Oriented Programming and also taught me the basics of DevOps and the associated features (user stories, pipelines, unit tests and deployment.)
...
<p align="center"> <img width="1151" height="570" alt="image" src="https://github.com/user-attachments/assets/a5a31db9-5950-42b6-bbf8-4d9b65c6c430" /> </p>
